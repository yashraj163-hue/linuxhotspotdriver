...
```
hey everyone,
Recently while trying to update and download a few python libraries in my wsl (windows subsystem linux) I faced an issue.
I was using my mobile hotspot to download the packages, which led to a heavy loss of packets probably due to the usage of
restricted ipv6 protocol while wsl uses ipv4.
